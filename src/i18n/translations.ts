...
const translations: Record<UiLanguage, TranslationBundle> = {
  "zh-CN": {
    ...
    panel: {
      ...
      settingsDescription: "API key 只会随请求发送到你填写的 Base URL。再设置模型、输出目录和图像参数。",
      previewTitle: "结果预览",
  ...
  "en-US": {
    ...
    panel: {
      ...
      settingsDescription: "Your API key is sent only to the Base URL you enter. Then set models, output folder, and image options.",
